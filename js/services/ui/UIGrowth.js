...
class UIGrowth {
    ...
    renderGrowthTab(kingdomId) {
        ...
        // Render Date Range (Always try to render, even if empty, to show "Waiting for scans")
        ...
        this.renderTable(kingdomId, growthData);
    }
            ...
            if (card) {
                ...
                card.onclick = () => {
                    ...
                    if (this.currentFilter === gradeFilter) {
                        ...
                        this.renderTable(kingdomId, this.currentGrowthData); // Render full data
                    } else {
                        ...
                        const filtered = this.currentGrowthData.filter(p => {
                            if (gradeFilter === 'C') return p.grade === 'C' || p.grade === 'D';
                            return p.grade === gradeFilter;
                        });

        ...
        types.forEach(type => {
            ...
            if (loadBtn) {
                loadBtn.addEventListener('click', async () => {
                    ...
                    if (!id) return;
                    try {
                        const result = await this.data.loadScanFromStorage(id);
                        // Mimic the "Handle Files" result
                        // { data, date, kingdoms }
                        ...
                        kingdoms.forEach(kId => {
                            ...
                            // Replace or Append? User likely wants to replace if loading a profile.
                            // But maybe separate kingdoms? 
                            // Let's CLEAR existing data for this type to allow "Switching".
